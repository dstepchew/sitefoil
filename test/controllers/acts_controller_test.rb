...
class ActsControllerTest < ActionController::TestCase
  ...
  test "should create act" do
    assert_difference('Act.count') do
      post :create, act: { channel_id: @act.channel_id, description: @act.description, name: @act.name }
    end
  ...
  test "should update act" do
    patch :update, id: @act, act: { channel_id: @act.channel_id, description: @act.description, name: @act.name }
    assert_redirected_to act_path(assigns(:act))
  end
